...
{
    public function agentPropertyView(){
        $id = Auth::user()->id;
        $allData = Property::where('agent_id',$id)->latest()->get();
        return view('agent.property.index',compact('allData'));
    } // End Method

    public function agentPropertyAdd(){
        $propertyType = PropertyType::latest()->get();
        $propertyAmenity = PropertyAmenity::latest()->get();
        $propertyFacility = PropertyFacility::latest()->get();
        $activeAgent = User::where('status', 'active')->where('role','agent')->latest()->get();
        return view('agent.property.add_property',compact('propertyType','propertyAmenity','activeAgent','propertyFacility'));
    } // End Method
    ...
    public function agentPropertyStore(Request $request){
        ...
        return redirect()->route('agent-property.view')->with($notification);
     } //End Method


    public function agentPropertyEdit($id, $slug){
        ...
        return view('agent.property.edit_property', compact('property', 'propertyType', 'propertyAmenities', 'propertyFacility', 'activeAgent', 'property_ami', 'multiImage','facilities'));
    }


    public function agentPropertyUpdate(Request $request){
        $request->validate([
            'property_name' => 'required',
            'property_status' => 'required',
            // 'prt_type' => 'required',
    ...
    public function agentPropertyThumbnailUpdate(Request $request){
        $request->validate([
            'id' => 'required',
    ...
    public function agentPropertyMultiimageUpdate(Request $request)
    {
    ...
    public function agentPropertystoreMultiimage(Request $request)
    {
    ...
    public function agentPropertyFacilitiesUpdate(Request $request)
    {
        $pid = $request->id;
    ...
    public function agentPropertyDelete($id)
    {
    ...
    public function agentPropertyDetails($id, $slug){
        ...
        $multiImage = MultiImage::where('property_id', $id)->get();
        $facilities = Facility::where('property_id',$id)->get();
        return view('agent.property.property_details', compact('property', 'propertyType', 'propertyAmenities', 'propertyFacility', 'activeAgent', 'property_ami', 'multiImage','facilities'));
    }
