...
<div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
    ...
    <div class="card-body p-0">
        <div class="p-4 code-to-copy">
            <div class="mb-3 row">
                <form id="myForm" method="POST" action="{{ route('property.update') }}" enctype="multipart/form-data">
                    @csrf
                        ...
                        {{-- <div class="col-sm-4">
                            <div class="mb-3">
                                ...
                                <select name="prt_type" class="form-select form-control">
                                    <option value="" selected disabled>-- Select --</option>
                                    @foreach($propertyType as $pro)
                                        <option value="{{ $pro->property_type_name }}" {{ $property->prt_type == $pro->property_type_name ? 'selected' : '' }}>{{ $pro->property_type_name }}</option>
                                    @endforeach
                                </select>
                                <small class="form-control-feedback">
                                    @error('prt_type')
...
<div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
    <div class="card-header p-4 border-bottom border-300 bg-soft">
        <div class="row g-3 justify-content-between align-items-center">
            <div class="col-4 col-md">
                <h4 class="text-900 mb-0" data-anchor="data-anchor">Edit Main Thumbnail</h4>
            </div>
        </div>
    </div>
    ...
    <div class="card-body p-0">
        <div class="p-4 code-to-copy">
            <div class="mb-3 row">
                <form id="myForm" method="POST" action="{{ route('property.thumbnail.update') }}" enctype="multipart/form-data">
                    @csrf
...
<div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
    <div class="card-header p-4 border-bottom border-300 bg-soft">
        <div class="row g-3 justify-content-between align-items-center">
            <div class="col-4 col-md">
                <h4 class="text-900 mb-0" data-anchor="data-anchor">Edit Multiple Image</h4>
            </div>
        </div>
    </div>
    ...
    <div class="card-body p-0">
        <div class="p-4 code-to-copy">
            <div class="mb-3 row">
                <form id="myForm" method="POST" action="{{route('property.multiimage.update')}}" enctype="multipart/form-data">
                    @csrf
                                        ...
                                        <table class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <button type="submit" class="btn btn-primary btn-sm px-3" title="Update Image">Update Image</i>
                                                        </button>
                                                        <a href="{{ route('property.multiimg.delete',$img->id) }}" class="btn btn-danger" id="delete_data">Delete </a>
                                                    </td>
                                                </tr>
                                                @endforeach
                                            </tbody>
                ...
                <form id="myForm" method="POST" action="{{route('store.multiimage')}}" enctype="multipart/form-data">
                    @csrf
...
<div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
    <div class="card-header p-4 border-bottom border-300 bg-soft">
        <div class="row g-3 justify-content-between align-items-center">
            <div class="col-12 col-md">
                <h4 class="text-900 mb-0" data-anchor="data-anchor">Edit Facility</h4>
            </div>
        </div>
    </div>
    <div class="card-body p-0">
        <div class="p-4 code-to-copy">
            <div class="mb-3 row">
                <form id="myForm" method="POST" action="{{ route('property.facilities.update') }}" enctype="multipart/form-data">
                    @csrf
                    <input type="hidden" name="id" value="{{ $property->id }}">
