...
<div class="card shadow-none border border-300 my-4" data-component-card="data-component-card">
    ...
    <div class="card-body p-0">
        <div class="p-4 code-to-copy">
            <div class="mb-3 row">
                <form id="myForm" method="POST" action="{{ route('property-amenities.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-sm-8">
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" placeholder="Property Amenity Name" name="property_amenity_name">
...
<div class="card shadow-none border border-300 my-5" data-component-card="data-component-card">
    <div class="card-header p-4 border-bottom border-300 bg-soft">
        <div class="row g-3 justify-content-between align-items-end">
            <div class="col-12 col-md">
                <h4 class="text-900 mb-0">@yield('title')</h4>
                <p class="mb-0 mt-2 text-800">Available Property Amenities.</p>
            </div>
        </div>
    </div>
        ...
        <div class="p-4 code-to-copy table-responsive pt-3">
            <table id="propertyTable" class="table table-bordered text-center">
                <thead>
                    <tr>
                        <th scope="col">#</th>
                        <th scope="col">Property Amenities Name</th> 
                ...
                <tbody>
                    ...
                    <tr class="{{ $colors[$key % count($colors)] }}">
                        <td>{{ $key+1 }}</td>
                        <td>{{ $item->property_amenity_name }}</td>
                        <td>
...
<script>
    $(document).ready(function() {
        $('#myForm').submit(function(e) {
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('property-amenities.store') }}",
                data: formData,
